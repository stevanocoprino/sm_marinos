      ...
      <div class="box">
                ...
                <div class="row" style="padding:2%">
                        		...
                        		<div class="card-box">
									...
									?>
<form role="form" id="step2form" enctype='multipart/form-data' method="POST" action="<?=base_url("backend/proses_tambah_service")?>">
								...
								<div class="row ">
                                    ...
                                    <div class="col-lg-12">
										...
										<div class="form-group col-lg-6">
                                            ...
                                            <input class="form-control" name="service[deskripsi]" placeholder="Deskripsi">
										</div>
										
										<div class="form-group col-lg-6">
                                            <label>Description</label>
                                            <input class="form-control" name="service[deskripsi_en]" placeholder="Description">
										</div>
